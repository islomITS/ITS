...
let about_block_box__control = document.querySelector('.about-block_box__control');
let about_block_box__control_bg = document.querySelector('.about-block_box__control-bg');
about_block_box__control.addEventListener('click' , function ()  {
    about_block_box__control_bg.style.width = '0',
    about_block_box__control_bg.style.height = '0',
    about_block_box__control_bg.style.display = 'none'
});